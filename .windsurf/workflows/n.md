...
; Barcode Fonts - 3OF9_BARCODE folder (properly install fonts)
Source: "E:\3of9_barcode\*.ttf"; DestDir: "{fonts}"; FontInstall: "3 of 9 Barcode"; Flags: onlyifdoesntexist uninsneveruninstall
Source: "E:\3of9_barcode\*.TTF"; DestDir: "{fonts}"; FontInstall: "3 of 9 Barcode"; Flags: onlyifdoesntexist uninsneveruninstall

; Barcode Fonts - Free_3_of_9 folder (properly install fonts)
Source: "E:\Free_3_of_9\*.ttf"; DestDir: "{fonts}"; FontInstall: "Free 3 of 9"; Flags: onlyifdoesntexist uninsneveruninstall
Source: "E:\Free_3_of_9\*.TTF"; DestDir: "{fonts}"; FontInstall: "Free 3 of 9"; Flags: onlyifdoesntexist uninsneveruninstall

; SQL ODBC Drivers (SQL Server ODBC Driver 17 and 18)
